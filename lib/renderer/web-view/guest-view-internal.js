...
module.exports = {
  ...
  createGuest: function (params, callback) {
    ipcRenderer.invoke('ELECTRON_GUEST_VIEW_MANAGER_CREATE_GUEST', params).then(callback)
  },
  createGuestSync: function (params) {
    return ipcRenderer.invokeSync('ELECTRON_GUEST_VIEW_MANAGER_CREATE_GUEST_SYNC', params)
  },
