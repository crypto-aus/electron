...
const setupMethods = (WebViewElement) => {
  ...
  const createBlockHandler = function (method) {
    return function (...args) {
      return ipcRenderer.invokeSync('ELECTRON_GUEST_VIEW_MANAGER_SYNC_CALL', getGuestInstanceId(this), method, args)
    }
  }
  ...
  const createNonBlockHandler = function (method) {
    return function (...args) {
      ...
      ipcRenderer.invoke('ELECTRON_GUEST_VIEW_MANAGER_ASYNC_CALL', getGuestInstanceId(this), method, args, callback != null)
        .then(result => {
