...
ipcMain.handleSync('CHROME_GET_MESSAGES', function (event, extensionId, language) {
...
ipcMain.handle('CHROME_STORAGE_READ', async function (event, storageType, extensionId) {
...
ipcMain.handle('CHROME_STORAGE_WRITE', async function (event, storageType, extensionId, data) {
