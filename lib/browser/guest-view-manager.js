...
ipcMain.handle('ELECTRON_GUEST_VIEW_MANAGER_CREATE_GUEST', function (event, params) {
  assertWebViewTagEnabled(event)
  return createGuest(event.sender, params)
})

ipcMain.handleSync('ELECTRON_GUEST_VIEW_MANAGER_CREATE_GUEST_SYNC', function (event, params) {
  assertWebViewTagEnabled(event)
  return createGuest(event.sender, params)
})
...
ipcMain.handle('ELECTRON_GUEST_VIEW_MANAGER_ASYNC_CALL', function (event, guestInstanceId, method, args, hasCallback) {
...
ipcMain.handleSync('ELECTRON_GUEST_VIEW_MANAGER_SYNC_CALL', function (event, guestInstanceId, method, args) {
  assertWebViewTagEnabled(event)
