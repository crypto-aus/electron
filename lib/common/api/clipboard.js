...
if (process.platform === 'linux' && process.type === 'renderer') {
  ...
  if (process.platform === 'darwin' && process.type === 'renderer') {
    ...
    clipboard.readFindText = (...args) => ipcRenderer.invokeSync('ELECTRON_BROWSER_CLIPBOARD_READ_FIND_TEXT', ...args)
    clipboard.writeFindText = (...args) => ipcRenderer.invokeSync('ELECTRON_BROWSER_CLIPBOARD_WRITE_FIND_TEXT', ...args)
  }
